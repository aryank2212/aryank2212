...
<div align="center">
  <!-- X / Twitter Style Post Frame -->
  <table width="600" style="border: 1px solid #444; border-radius: 12px; padding: 20px; background-color: #000; color: #fff;">
    <tr>
      <td width="55" valign="top">
        <img src="https://github.com/aryank2212.png" width="48" style="border-radius: 50%;" alt="Profile Picture" />
      </td>
      <td valign="top">
